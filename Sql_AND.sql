...
Select * from students 
where name="John" and marks >80;

select * from students 
where marks > 70 and fail_subjects =1;

select * from students 
where name like "C%" and marks >70;

select * from students;

select * from students where city like "M%" and marks>75 and fail_subjects =1;
